...
@Component({
  selector: 'app-cart-kitchen-cart',
  templateUrl: './cart-kitchen-cart.component.html',
  styleUrls: ['./cart-kitchen-cart.component.scss']
})
export class CartKitchenCartComponent implements OnInit {
